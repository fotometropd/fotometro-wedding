...
export function FloatingViberButton() {
  ...
  return (
    ...
    >
      <a 
        href={viberLink}
        className="group relative flex items-center justify-center w-14 h-14 bg-obsidian text-white rounded-full shadow-2xl hover:bg-charcoal transition-all duration-300 hover:scale-105"
        aria-label="Kontaktirajte nas na Viber"
      >
        <MessageCircle size={24} strokeWidth={1.5} />
        
        {/* Hover Tooltip */}
        <span className="absolute right-16 px-4 py-2 bg-white text-obsidian text-[10px] font-body tracking-[0.2em] uppercase rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap border border-stone/10">
          Viber Poruka
        </span>
