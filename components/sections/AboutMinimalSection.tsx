          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="space-y-8">
              ...
              <div className="space-y-6 font-body text-[#555555] text-[15px] leading-loose font-light">
                ...
                <p>
                  Naš pristup je dokumentaran i nenametljiv. Ne režiramo vaše vjenčanje; mi ga bilježimo onakvim kakvo ono zaista jeste. Od intimnih proslava u Bosni i Hercegovini do luksuznih destinacijskih vjenčanja širom Evrope, tu smo da stvorimo vizuelno naslijeđe za generacije koje dolaze.
                </p>
              </div>

              <div className="pt-6">
                <Link href="/o-meni" className="inline-block border-b border-[#111111] pb-1 font-body text-[10px] tracking-[0.2em] uppercase text-[#111111] hover:text-[#777777] hover:border-[#777777] transition-colors">
